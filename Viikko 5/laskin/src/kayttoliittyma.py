...
class Summa:
    def __init__(self, sov, inp):
        self.sov=sov
        self.inp=inp
    def suorita(self):
        self.sov.plus(self.inp())
...
class Kayttoliittyma:
    def __init__(self, sovellus, root):
        ...
        self._root = root
        #self._komennot = {
        #    Komento.SUMMA: self._sovellus.plus(self.lue_syote()),
        #    Komento.EROTUS: self._sovellus.miinus(self.lue_syote()),
        ...
        self._komennot = {
            ...
            Komento.KUMOA: Kumoa(sovellus, self.lue_syote) # ei ehkä tarvita täällä...
        }
    def kaynnista(self):
