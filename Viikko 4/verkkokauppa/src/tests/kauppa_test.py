...
class TestKauppa(unittest.TestCase):
    ...
    def test_kahden_eri_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kahden_saman_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_aloita_asiointi_resettaa_tuotteet(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        ...
        kauppa.tilimaksu("pekka", "12345")
        kauppa.aloita_asiointi()
        kauppa.tilimaksu('jami', '12345')

        # varmistetaan, että metodia tilisiirto on kutsuttu
        
        pankki_mock.tilisiirto.assert_called_with('jami', 42, '12345', '33333-44455', 0)
